...
// if the fields are not empty, we will elseif they are set
    ...
    if($dollars < 750) {
        ...
        <h2>I am NOT happy, because I have $'.number_format($dollars,2).' American dollars!</h2>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/8il_8THnCKM?si=mBWXF12eEAeyooE7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        ';
    } else{
        echo'
        ...
        <h2>I am happy, because I have $'.number_format($dollars,2).' American dollars!</h2>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/NHGMy662U00?si=ttcoQXiuy7_F9ukQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        ';
