...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
   if(isset($_POST['cel'])) {
    $cel = $_POST['cel'];
    // we will use a new function to make sure that our values are integers intal()
    $cel_int = intval($cel);
    $far = ($cel_int *9/5) +32;
    ...
    elseif($far <= 45) {
     ...
     elseif($far <= 60) {
            echo'<p> '.$cel_int.' degrees celcius equals '.$far.' degrees fahrenheit <br> and it is a sweater day! </p>';
            }
